...
from panoptic_reconstruction.utils import load_yaml, get_relative_path
from panoptic_reconstruction.DAD_3DHeads_model.head_mesh import HeadMesh
from panoptic_reconstruction.DAD_3DHeads_model.model.utils import to_device, unravel_index, calculate_paddings
from panoptic_reconstruction.DAD_3DHeads_model.data.config import OUTPUT_3DMM_PARAMS, OUTPUT_2D_LANDMARKS, OUTPUT_LANDMARKS_HEATMAP
...
class FaceMeshPredictor:
    def __init__(self, config: Dict[str, Any], cuda_id: int = 0, original = True):
        ...
        if(original):
            ...
            path1 = '/home/esther/Escritorio/DAD_3DHeads/experiments/train/2023-12-16-18-55-26/academic_experiment/checkpoints/epoch_0011-valid_metrics_reproject_nme_2d_795.4548.trcd'
            self.model = torch.jit.load(path1)
